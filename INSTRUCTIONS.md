...
This file provides foundational instructions and context for AI agents (Gemini CLI, Claude Code, and others) when working on the CS271-Project.
...
- **Notebook Development:** When modifying notebooks, maintain the experimental and iterative nature of the analysis while ensuring code blocks are well-documented. Suppress expected, non-critical warnings (e.g., Pandas fragmentation and Scanpy's few-observations warnings during differential expression) to maintain clean notebook outputs.
